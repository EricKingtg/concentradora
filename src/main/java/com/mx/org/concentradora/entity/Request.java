...
public class Request implements Serializable {
	...
	public Request(String tclave, String caja, int idturno, int idticket, int iclave, int pclave, String icb,
			int folio, Date fecha, int estatus, Timestamp atmfecha, int userid, Float monto, String referencia) {
		super();
		this.tclave = tclave;
		this.caja = caja;
